...
public class HoaDonForm extends javax.swing.JFrame {
    ...
    private List<KhachHangCustom> listQLKH = new ArrayList<>();
    private List<HoaDonCustom> listQLHD = new ArrayList<>();
    ...
    public void showData(List<HoaDonCustom> list) {
        dtm.setRowCount(0);
        for (HoaDonCustom d : list) {
            Object[] rowData = {
                d.getId(),
                d.getMa(),
                d.getDiaChi(),
    ...
    public void fillData(int index) {
        HoaDonCustom ql = listQLHD.get(index);
    ...
    public void LoadCbb() {
        ...
        for (KhachHangCustom qLKhachHang : listQLKH) {
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        HoaDonCustom qlhd = listQLHD.get(chon);
        HoaDonCustom hd = check();
        if (hd == null) {
            return;
        }
...
//        String idnv = this.cbbIdNV.getSelectedItem().toString();
        ...
        HoaDonCustom qlhd = new HoaDonCustom();
        qlhd.setMa(gen("HD"));
        qlhd.setSdt(sdt);
