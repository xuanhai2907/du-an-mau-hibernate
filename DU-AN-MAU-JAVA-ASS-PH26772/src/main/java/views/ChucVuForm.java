...
public class ChucVuForm extends javax.swing.JFrame {
    ...
    public void showData(List<ChucVuCustom> list) {
        dtm.setRowCount(0);
        for (ChucVuCustom qLChucVu : list) {
            dtm.addRow(qLChucVu.toRowData());
        }
    }

    public void fillData(int index) {
        ChucVuCustom ql = listQLCV.get(index);
        lbID.setText(String.valueOf(ql.getId()));
        txtMa.setText(ql.getMa());
        txtTen.setText(ql.getTen());
    }

    private ChucVuCustom Mouse() {
    ...
    private ChucVuCustom check() {
        ...
        ChucVuCustom qlcv = new ChucVuCustom();
        qlcv.setMa(gen("CV"));
        qlcv.setTen(ten);
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        ChucVuCustom qlcv = listQLCV.get(chon);
        ChucVuCustom vu = check();
        if (vu == null) {
            return;
        }
        vu.setId(qlcv.getId());
