...
public class GioHangForm extends javax.swing.JFrame {
    ...
    public GioHangForm() {
        ...
        List<NhanVienCustom> nhanvien = this.qlnv.getList();
        for (NhanVienCustom nhanVien : nhanvien) {
            String manv = "";
            manv = nhanVien.getMa();
            this.cbbIdNV.addItem(manv);
        }
        List<KhachHangCustom> khachhang = qlkh.getList();
        for (KhachHangCustom khachHang : khachhang) {
            String makh = "";
    ...
    private GioHang getFormData() {
        ...
        KhachHangCustom idKH = null;
        NhanVienCustom idNV = null;
        ...
        qlkh = new KhachHangServiceImpl();
        List<KhachHangCustom> ls = qlkh.getList();
        ...
        qlnv = new NhanVienServiceImpl();
        List<NhanVienCustom> list = qlnv.getList();
        for (NhanVienCustom l : list) {
