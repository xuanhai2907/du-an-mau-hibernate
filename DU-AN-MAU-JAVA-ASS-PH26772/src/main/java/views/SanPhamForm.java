...
public class SanPhamForm extends javax.swing.JFrame {
    ...
    public void showData(List<SanPhamCustom> list) {
        dtm.setRowCount(0);
        for (SanPhamCustom sp : list) {
            dtm.addRow(sp.toRowData());
        }
    }
    
    public void fillData(int index) {
        SanPhamCustom sp = ListSanPham.get(index);
    ...
    private SanPhamCustom checkValidate() {
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        SanPhamCustom sp = checkValidate();
        if (sp == null) {
            return;
        }
        service.them(sp);
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        SanPhamCustom qlsp = ListSanPham.get(s);
        sp.setId(qlsp.getId());
        sp.setMa(qlsp.getMa());
        service.sua(sp);
        ListSanPham = service.getAll();
